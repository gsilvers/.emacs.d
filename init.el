...
(custom-set-variables
 ...
 '(package-selected-packages
   '(keycast markdown-mode powershell multiple-cursors nyan-mode magit helpful counsel ivy-rich which-key rainbow-delimiters doom-themes doom-modeline ivy command-log-mode use-package)))
(custom-set-faces
