...
#+begin_src emacs-lisp :tangle ./init.el
    ...
    (defun my/add-global-capfs ()
    (add-hook 'completion-at-point-functions #'yasnippet-capf nil t)) ;; t = buffer-local

    (add-hook 'after-change-major-mode-hook #'my/add-global-capfs)
#+end_src
